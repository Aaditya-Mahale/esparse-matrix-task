  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        muiEditTextFieldProps: {
          required: true,
          error: !!validationErrors?.stocks,
          helperText: validationErrors?.stocks,
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              stocks: undefined,
...
const ExampleWithProviders1 = () => (
  <QueryClientProvider client={queryClient}>
    <Example />
  </QueryClientProvider>
);

export default ExampleWithProviders1;
