...
import { SelectBox, Img, Text, Button, Heading } from "../../components";
          ...
          <div className="flex flex-col md:self-stretch mt-[52px] gap-6 md:p-5 flex-1">
            ...
            <div className="h-[1491px] relative">
              ...
              <div className="h-[1491px] w-full md:h-auto left-0 bottom-0 right-0 top-0 m-auto absolute">
                ...
                <div className="flex flex-col items-end w-[97%] gap-[68px] top-[6%] right-0 left-0 m-auto sm:gap-[34px] absolute">
                  <div className="flex justify-between w-[85%] md:w-full mr-[33px] gap-5 md:mr-0">
                    <Heading
                      size="3xl"
                      as="h1"
                      className="flex justify-center items-center h-[45px] pl-[23px] pr-[34px] py-[3px] sm:px-5 !text-black-900 border-gray-600 border border-solid bg-blue_gray-100 rounded-[5px]"
                    >
                      150
                    </Heading>
                    <Button
                      ...
                      size="sm"
                      shape="round"
                      className="font-semibold border-gray-600 border border-solid min-w-[303px]"
                    >
                      Add New Products
                    </Button>
                  </div>
                  <div className="flex flex-col self-stretch items-start gap-[31px] p-[23px] sm:p-5 border-black-900_3f border border-solid bg-white-A700 rounded-[5px]">
                    <Text size="3xl" as="p" className="mt-[47px]">
                      Sr No Product Id Product Name Category Stocks Price Actions{" "}
                    </Text>
                    <div className="flex md:flex-col self-stretch items-start mb-[846px] gap-[49px]">
                      <Text size="3xl" as="p" className="mt-[7px]">
                        01 PO123 Tiro track jacket Clothing Yes Rs.120{" "}
                      </Text>
                      <SelectBox
                        shape="round"
                        ...
                        className="w-[15%] md:w-full gap-px sm:px-5 font-medium border-black-900 border border-solid"
                      />
                    </div>
                  </div>
                </div>
